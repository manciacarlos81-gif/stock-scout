...
- SEC filings: https://www.sec.gov/cgi-bin/browse-edgar?action=getcompany&CIK=1110646&type=&dateb=&owner=include&count=40
- Yahoo Finance: https://finance.yahoo.com/quote/NTES
- Insider trades: http://openinsider.com/NTES
- Full deep dive: run `python scout.py stock NTES` → `research/NTES.md`
